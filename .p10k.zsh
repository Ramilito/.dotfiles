# Generated by Powerlevel10k configuration wizard on 2022-05-12 at 14:37 CEST.
...
#
    ...
    typeset -g POWERLEVEL9K_KUBECONTEXT_DELIVERY_FOREGROUND=011
    typeset -g POWERLEVEL9K_KUBECONTEXT_DELIVERY_VISUAL_IDENTIFIER_EXPANSION='❗'

    typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_FOREGROUND=252
    typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_BACKGROUND=124
    ...
    typeset -g POWERLEVEL9K_KUBECONTEXT_DOCKER_FOREGROUND=002
    # typeset -g POWERLEVEL9K_KUBECONTEXT_DOCKER_BACKGROUND=196
    typeset -g POWERLEVEL9K_KUBECONTEXT_DOCKER_VISUAL_IDENTIFIER_EXPANSION='✅️'
