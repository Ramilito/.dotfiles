...
-- -- Resize windows
map("n", "<C-S-Left>", ":vertical resize -2<CR>", { desc = "Resize left", noremap = true, silent = true })
map("n", "<C-S-Right>", ":vertical resize +2<CR>", { desc = "Resize rigth", noremap = true, silent = true })
...
map("v", "<leader>/", "<Plug>(comment_toggle_linewise_visual)", { desc = "Comment", noremap = true, silent = true })
...
map("n", "<leader>e", "<cmd> NvimTreeToggle <CR>", { desc = "Explorer", noremap = true, silent = true })

map("n", "<leader>gu", "<cmd> UndotreeToggle <CR>", { desc = "Explorer", noremap = true, silent = true })
...
map(
	"n",
	"<leader>nj",
	"<cmd>Neorg workspace notes <cr> <bar> <cmd> Neorg journal today<cr>",
	{ desc = "Norg", noremap = true, silent = true }
)
